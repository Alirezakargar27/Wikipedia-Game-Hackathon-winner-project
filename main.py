...
def get_random_title():
    ...
    # return a list of tiles similiar to the topic
...
def main():
    ...
    for player in range(number_of_players):
        ...
        print(
            "Your journey begins with a title from a randomly selected Wikipedia article.\n")
        ...
        while wrong_guesses < 3:
            ...
            # checks if the similarity score is above 85% and if guessed_title was guessed befor
    ...
    ordered_ranking_list = sorted(
        ranking_dict.items(), key=lambda item: int(item[1]), reverse=True)
